...
class RINDataset(Dataset):
    ...
    def __init__(self, args, mode='train'):
        self.args = args
        images, c2w, H, W, focal_x, focal_y, image_paths, all_depth_hypothesis = load_meta_data(
            args, mode=mode)
    ...
    def get_depth_hypothesis(self, img_idx):
        return self.all_depth_hypothesis[img_idx]
